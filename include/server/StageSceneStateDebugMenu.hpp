...
class StageSceneStateDebugMenu : public al::HostStateBase<al::Scene>, public al::IUseMessageSystem {
public:
    StageSceneStateDebugMenu(const char*, al::Scene*, const al::LayoutInitInfo&, FooterParts*,
                             GameDataHolder*, bool);
...
namespace {
NERVE_HEADER(StageSceneStateDebugMenu, MainMenu)
}